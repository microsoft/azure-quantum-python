              ...
              "entries": [
                  {
                      ...
                      "explanation": "This value represents the total number of physical qubits, which is the sum of 20250 physical qubits to implement the algorithm logic, and 504000 physical qubits to execute the T factories that are responsible to produce the T states that are consumed by the algorithm.",
                      "label": "Physical qubits",
                      "path": "physicalCounts/physicalQubits"
                  },
                  {
                      "description": "Total runtime",
                      "explanation": "This is a runtime estimate (in nanosecond precision) for the execution time of the algorithm.  In general, the execution time corresponds to the duration of one logical cycle (6us) multiplied by the 7545 logical cycles to run the algorithm.  If however the duration of a single T factory (here: 83us 200ns) is larger than the algorithm runtime, we extend the number of logical cycles artificially in order to exceed the runtime of a single T factory.",
                      "label": "Runtime",
          ...
          },
          {
              ...
              "entries": [
                  ...
                  },
                  {
                      ...
                      "explanation": "To execute the algorithm using _Parallel Synthesis Sequential Pauli Computation_ (PSSPC), operations are scheduled in terms of multi-qubit Pauli measurements, for which assume an execution time of one logical cycle.  Based on the input algorithm, we require one multi-qubit measurement for the 0 single-qubit measurements, the 882 arbitrary single-qubit rotations, and the 186 T gates, three multi-qubit measurements for each of the 0 CCZ and 0 CCiX gates in the input program, as well as 17 multi-qubit measurements for each of the 381 non-Clifford layers in which there is at least one single-qubit rotation with an arbitrary angle rotation.",
                  ...
                  },
                  {
                      ...
                      "explanation": "This number is usually equal to the logical depth of the algorithm, which is 7545.  However, in the case in which a single T factory is slower than the execution time of the algorithm, we adjust the logical cycle depth to exceed the T factory's execution time.",
                      "label": "Logical depth",
                      "path": "physicalCounts/breakdown/logicalDepth"
                  },
                  {
                      "description": "Number of T states consumed by the algorithm",
                      "explanation": "To execute the algorithm, we require one T state for each of the 186 T gates, four T states for each of the 0 CCZ and 0 CCiX gates, as well as 17 for each of the 882 single-qubit rotation gates with arbitrary angle rotation.",
                      "label": "Number of T states",
                      "path": "physicalCounts/breakdown/numTstates"
                  },
                  {
                      "description": "Number of T factories capable of producing the demanded 15180 T states during the algorithm's runtime",
                      "explanation": "The total number of T factories 28 that are executed in parallel is computed as $\\left\\lceil\\dfrac{15180\\;\\text{T states} \\cdot 83us 200ns\\;\\text{T factory duration}}{1\\;\\text{T states per T factory} \\cdot 45ms 270us\\;\\text{algorithm runtime}}\\right\\rceil$",
                  ...
                  },
                  {
                      ...
                      "explanation": "In order to prepare the 15180 T states, the 28 copies of the T factory are repeatedly invoked 543 times.",
                  ...
                  },
                  {
                      ...
                      "explanation": "The 20250 are the product of the 45 logical qubits after layout and the 450 physical qubits that encode a single logical qubit.",
                  ...
                  },
                  {
                      ...
                      "explanation": "Each T factory requires 18000 physical qubits and we run 28 in parallel, therefore we need $504000 = 18000 \\cdot 28$ qubits.",
                  ...
                  },
                  {
                      ...
                      "explanation": "The minimum logical qubit error rate is obtained by dividing the logical error probability 3.33e-4 by the product of 45 logical qubits and the total cycle count 7545.",
                  ...
                  },
                  {
                      ...
                      "explanation": "The minimum T state error rate is obtained by dividing the T distillation error probability 3.33e-4 by the total number of T states 15180.",
                  ...
                  },
                  {
                      ...
                      "explanation": "The number of T states to implement a rotation with an arbitrary angle is $\\lceil 0.53 \\log_2(882 / 0.0003333333333333333) + 5.3\\rceil$ [[arXiv:2203.10064](https://arxiv.org/abs/2203.10064)].  For simplicity, we use this formula for all single-qubit arbitrary angle rotations, and do not distinguish between best, worst, and average cases.",
          ...
          },
          {
              ...
              "entries": [
                  ...
                  },
                  {
                      ...
                      "explanation": "The code distance is the smallest odd integer greater or equal to $\\dfrac{2\\log(0.03 / 0.0000000009817637385563163)}{\\log(0.01/0.001)} - 1$",
                      "label": "Code distance",
                  ...
                  },
                  {
                      ...
                      "explanation": "The logical qubit error rate is computed as $0.03 \\cdot \\left(\\dfrac{0.001}{0.01}\\right)^\\frac{15 + 1}{2}$",
                  ...
                  },
                  {
                      ...
                      "explanation": "This is the formula that is used to compute the logical cycle time 6us.",
          ...
          },
          {
              ...
              "entries": [
                  ...
                  },
                  {
                      ...
                      "explanation": "The T factory takes as input 270 noisy physical T states with an error rate of 0.001 and produces 1 T states with an error rate of 2.16e-8.",
                  ...
                  },
                  {
                      ...
                      "explanation": "This is the logical T state error rate achieved by the T factory which is equal or smaller than the required error rate 2.20e-8.",
...
class SpaceDiagramComponent extends HTMLElement {
  connectedCallback() {
    ...
    if (data) {
      ReactDom.render(<SpaceDiagram width={1000} height={1000} data={data}/>, mountPoint);
    } else {
