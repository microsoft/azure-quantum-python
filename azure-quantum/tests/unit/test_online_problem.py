...
# -*- coding: utf-8 -*-
##
# test_online_problem.py: Checks correctness of azure.quantum.target.optimization module.
##
# Copyright (c) Microsoft Corporation. All rights reserved.
# Licensed under the MIT License.
##
from unittest.mock import Mock, patch
from azure.quantum.target.optimization import Problem, OnlineProblem
