...
from azure.quantum.target.optimization import Problem, ProblemType, Term, GroupedTerm, GroupType
import azure.quantum.target.optimization as microsoft
import azure.quantum.target.optimization.oneqbit as oneqbit
import azure.quantum.target.optimization.toshiba as toshiba
...
def get_solver_types():
    ...
    for solver_type in SOLVER_TYPES:
        ...
        if (solver_type_name.startswith("azure.quantum.target.optimization.solvers.") # Microsoft solvers
