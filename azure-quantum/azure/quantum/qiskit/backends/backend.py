...
class AzureBackend(Backend):
    ...
    def _translate_input(self, circuit, data_format, input_params):
        ...
        # By default, we'll transpile into the list of supported instructions unless the user
        # has indicated that this step should be skipped.
        auto_transpile = not input_params["skip-auto-transpile"] if "skip-auto-transpile" in input_params else True
