...
class AzureQuantumService:
    ...
    def create_job(
        ...
        :type program: :py:obj:`cirq.Circuit`
        ...
        :type param_resolver: :py:obj:`cirq.ParamResolverOrSimilarType`
        :return: Job
        :rtype: azure.quantum.cirq.Job
        """
        # Get target
...
see https://aka.ms/AQ/Docs/AddProvider")
    ...
    def run(
        ...
        :type seed: :py:obj:`cirq.RANDOM_STATE_OR_SEED_LIKE`
        :param timeout_seconds: Timeout in seconds, defaults to None
        :type timeout_seconds: int
        :return: Measurement results
        :rtype: :py:obj:`cirq.Result`
        """
        job = self.create_job(
            program=program,
            repetitions=repetitions,
