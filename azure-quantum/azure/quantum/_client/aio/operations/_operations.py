...
class JobsOperations:
    ...
    @distributed_trace
    def list(self, *, filter: Optional[str] = None, **kwargs: Any) -> AsyncIterable["_models.JobDetails"]:
        """List jobs.
...
class SessionsOperations:
    ...
    @distributed_trace
    def list(self, *, filter: Optional[str] = None, **kwargs: Any) -> AsyncIterable["_models.SessionDetails"]:
        """List sessions.
    ...
    @distributed_trace
    def jobs_list(
        self, session_id: str, *, filter: Optional[str] = None, **kwargs: Any
...
class TopLevelItemsOperations:
    ...
    @distributed_trace
    def list(self, *, filter: Optional[str] = None, **kwargs: Any) -> AsyncIterable["_models.ItemDetails"]:
