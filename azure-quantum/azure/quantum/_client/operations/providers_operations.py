...
class ProvidersOperations(object):
    ...
    def get_status(self, custom_headers=None, raw=False, **operation_config):
        """Get provider status.
        ...
        deserialized = models.ProviderStatusPaged(
            internal_paging, self._deserialize.dependencies
        )

        if raw:
            header_dict = {}
            client_raw_response = models.ProviderStatusPaged(
    ...
    get_status.metadata = {
        "url": "/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Quantum/workspaces/{workspaceName}/providerStatus"
    }
