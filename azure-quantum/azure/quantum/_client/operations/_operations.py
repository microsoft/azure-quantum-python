...
class JobsOperations:
    ...
    @distributed_trace
    def list(self, *, filter: Optional[str] = None, **kwargs: Any) -> Iterable["_models.JobDetails"]:
        """List jobs.
...
class SessionsOperations:
    ...
    @distributed_trace
    def list(self, *, filter: Optional[str] = None, **kwargs: Any) -> Iterable["_models.SessionDetails"]:
        """List sessions.
...
class TopLevelItemsOperations:
    ...
    @distributed_trace
    def list(self, *, filter: Optional[str] = None, **kwargs: Any) -> Iterable["_models.ItemDetails"]:
