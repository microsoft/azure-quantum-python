; ModuleID = 'Qiskit Sample - 3-qubit GHZ circuit'
...
entry:
  ...
  %c = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 3)
  ...
  %measurement4 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q1)
  %c1_1_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %c, i64 1)
  %c1_result_1 = bitcast i8* %c1_1_raw to %Result**
  %existing_value5 = load %Result*, %Result** %c1_result_1, align 8
  ...
  store %Result* %measurement4, %Result** %c1_result_1, align 8
  %measurement6 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %q2)
  %c2_2_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %c, i64 2)
  %c2_result_2 = bitcast i8* %c2_2_raw to %Result**
  %existing_value7 = load %Result*, %Result** %c2_result_2, align 8
